...
export default function Intro(props: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Reev.</span> A
        <span className="font-bold"> front-end developer</span> with
        <span className="font-bold"> 3 years</span> of experience. I enjoy
        developing
        <span className="italic"> web applications and problem solving</span>.
      ...
      >
        ...
        <a
          href="https://www.linkedin.com/in/reev/"
          target={"_blank"}
